...
namespace Synology.FileStation.List
{
	...
	public class ListRequest : FileStationRequest
	{
		...
		{
			return GetData<ListSharesResult>(new Synology.Parameters.SynologyRequestParameters(this)
			{
				Version = 2,
		...
		{
			return GetData<ListResult>(new Synology.Parameters.SynologyRequestParameters(this)
			{
				Version = 2,
				Additional = parameters,
			});
		...
		{
			return GetData<GetFileInfoResult>(new Synology.Parameters.SynologyRequestParameters(this)
			{
				Version = 2,
				Additional = parameters,
			});
